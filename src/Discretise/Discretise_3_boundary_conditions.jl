...
@inline (bc::AbstractBoundary)( # Used for all schemes (using "T")
    term::Operator{F,P,I,TimeTerm{T}}, colval, rowptr, nzval, cellID, zcellID, cell, face, fID, i, component, time
    ) where {F,P,I,T} = begin
    # nothing
...
@inline (bc::AbstractBoundary)(
    term::Operator{F,P,I,Si}, colval, rowptr, nzval, cellID, zcellID, cell, face, fID, i, component, time
    ) where {F,P,I} = begin
    0.0, 0.0
end
