# =============================================================================
# Compressible (Penalty) Oldroyd-B Benchmark — XCALibre.jl
# =============================================================================
#
# This example mimics the 'compressibleSolid_OldroydB' OpenFOAM benchmark.
# It solves the Oldroyd-B model without a pressure variable, using
# a large bulk penalty for incompressibility.
#
# Geometry: 2D Straight Channel (quad40.unv, 40x40 mesh, 1m x 1m)
# Parameters: mu_s = 1.0, mu_p = 1.0, lambda_p = 1.0, penalty = 1e6
# =============================================================================
...
@info "Penalty Oldroyd-B Benchmark: mu_s=$mu_s_val, mu_p=$mu_p_val, penalty=$penalty_val"
...
@info "Starting Penalty Oldroyd-B loop..."
...
save_output(u, "oldroyd_penalty_u", 0.0, config)
@info "Benchmark oldroyd_penalty finished."
