# =============================================================================
# Incompressible Oldroyd-B: Straight Channel (Periodic/Body Force Driven)
# =============================================================================
...
for step in 1:config.runtime.iterations
    for fID in 1:length(mesh_dev.faces)
        ...
        # Because periodic faces were moved to the end, they are treated as internal 
    ...
    if step == config.runtime.iterations
        report_results("Oldroyd Straight Periodic", res, u, p, txx)
    end
end
